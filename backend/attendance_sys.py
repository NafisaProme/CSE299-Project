...
while True:
    ...
    for encoded_face, location in zip(test_encoded, test_faces_location):
        matches = face_recognition.compare_faces(known_encodings_lst , test_encoded[0])
        face_distances = face_recognition.face_distance(known_encodings_lst,test_encoded[0])
